...
If CIT ran a trace that missed something important, we want to know. What was the change, what did CIT miss, what broke? These are the most valuable contributions and they improve the trace logic directly.
...
### 4. New node types
CIT-Chat currently tracks: facts, constraints, recommendations, assumptions, and tone/framing. Are there node types missing? Real examples help.

---

## What We Are Not Looking For

- Features that claim to fully solve enforcement or long-conversation degradation without a concrete technical mechanism. These are fundamental architecture limitations, and optimism without mechanism makes the disclosures dishonest.
